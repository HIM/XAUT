...
<%@ page import="medicines.domain.details.out" %><%--
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="#">销售单</a></li>
            </ul>
            <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <%
                        List<out> list = (List<out>) request.getAttribute("list");
...
//                            writer.close();
                    ...
                    <tr id="medicine_list">
                        ...
                        <td><%=outt.getSale_id()%></td>
                        <td><%=outt.getSale_date()%></td>
                    </tr>
                    <%
                            }
                        }
