...
<%@ page import="medicines.domain.details.in" %><%--
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li class="active"><a href="#">进货单</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <%
                        List<in> list = (List<in>) request.getAttribute("list");
...
//                            writer.close();
                    ...
                    <tr id="medicine_list">
                        ...
                        <td><%=inn.getPurchase_id()%></td>
                        <td><%=inn.getPurchase_date()%></td>
                    </tr>
                    <%
                            }
                        }
